...
public class JformatedTextFieldPreco extends JTextField {

    private static final NumberFormat MONETARY_FORMAT = new DecimalFormat("R$ #,##0.00");
    private NumberFormat numberFormat;
    private int limit = -1;

    public JformatedTextFieldPreco(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
    }

    public JformatedTextFieldPreco() {
        this(MONETARY_FORMAT);
    }

    public JformatedTextFieldPreco(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(JformatedTextFieldPreco.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
     ...
     * limit @param limit @param limit @param limit @param limit @param limit
     * @param limit
     */
