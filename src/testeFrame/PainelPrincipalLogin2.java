...
public class PainelPrincipalLogin2 extends javax.swing.JPanel {

    public LoginController2 controller;
    public ApplicationFrame tabed;

    public PainelPrincipalLogin2(ApplicationFrame tabed) {
        initComponents();

        this.tabed = tabed;
        controller = new LoginController2(this, tabed);
    ...
    private void autenticar() {
        try {
            ...
            Logger.getLogger(PainelPrincipalLogin2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
